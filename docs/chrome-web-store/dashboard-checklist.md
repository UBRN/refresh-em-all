# Manual Developer Dashboard checklist: Refresh Em All v2.5.0
...
- [ ] After upload, the dashboard shows version **2.5.0**.
...
- [ ] The v2.5.0 update has finished review and is actually serving to users.
